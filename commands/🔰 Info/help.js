  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_dc = new MessageButton().setStyle('url').setLabel('Invite me').setURL("https://discord.com/invite/invite-link").setEmoji("903579809425276929")
        let button_invite = new MessageButton().setStyle('url').setLabel('Support').setURL("https://dsc.gg/lym").setEmoji("902711733326610472")
        ...
        let FIRSTEMBED = new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter("Page Home\n" + client.user.username + " | music ", client.user.displayAvatarURL())
